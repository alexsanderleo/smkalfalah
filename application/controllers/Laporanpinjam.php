  ...
  public function __construct()
    ...
    public function index(){
      ...
      if(empty($tgl_awal) or empty($tgl_akhir)){ // Cek jika tgl_awal atau tgl_akhir kosong, maka :
          $transaksi = $this->Laporanpinjam_model->view_all();  // Panggil fungsi view_all yang ada di TransaksiModel
          $url_cetak = 'laporanpinjam/cetak';
          $label = 'Semua Data laporanpinjam';
      }else{ // Jika terisi
          $transaksi = $this->Laporanpinjam_model->view_by_date($tgl_awal, $tgl_akhir);  // Panggil fungsi view_by_date yang ada di TransaksiModel
          $url_cetak = 'laporanpinjam/cetak?tgl_awal='.$tgl_awal.'&tgl_akhir='.$tgl_akhir;
    ...
    public function cetak(){
      ...
      $pdf->Output('Data Pinjaman.pdf', 'D');
    }
