 ...
 <div class="box-header">
                <h3 class="box-title">Barang dikembalikan</h3>
              </div>
              <!-------------------------MEnambahkan buton-------------------->
              <div class="card-body">
...
<div class="btn pull-right">
              <a href="<?=base_url('pinjam/out/addout')?>" class="btn btn-primary">
              Tambah
                </a>     
              </div>
                  ...
                  foreach($row as $key => $data){  ?>
                   ...
                   <td><?=$no++?>.</td>
                    ...
                    <td><?=$data->status?></td>
                      ...
                      <a class="btn btn-danger btn-sm" href="<?=site_url('pinjam/in/deldua/'.$data->peminjam_id.'/'.$data->item_id)?>"onclick="return confirm('Yakin akan mengembalikan pinjaman barang?')">
                              </i>
                              Delete
                              </a>
                        </i>
