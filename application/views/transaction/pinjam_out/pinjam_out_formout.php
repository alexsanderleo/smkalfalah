...
<div class="box">
         <div class="box-header">
                <h3 class="box-title">Stock Out Barang masuk / pembelian</h3>
              </div>
              <!-------------------------MEnambahkan buton-------------------->
              <div class="card-body">
        <div class="col-md-4 col-md-offset-4">
          <a href="<?=site_url('pinjamout/out')?>" class="btn btn-secondary">Kembali</a>
        </div>
      </div>
</section>      
 ...
 <section class="content">
          ...
          <div class="card card-primary">
            ...
            <form action="<?=site_url('pinjam/processdua')?>" method="post">    
            <div class="card-body">
