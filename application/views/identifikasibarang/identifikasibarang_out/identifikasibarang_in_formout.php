...
<div class="box">
        ...
        <div class="col-md-4 col-md-offset-4">
          ...
          <div class="card card-primary">
            ...
            <form action="<?=site_url('identifikasibarang/processdua')?>" method="post">    
            <div class="card-body">
           ...
           <div class="form-group input-group">
             ...
             <div class="form-group">
                <label>Barcode kerusakan * </label>
                <input type="text" name="barcodekerusakane"  class="form-control" placeholder="Silahkan buat id barcode dan ditempel di kerusakan" >
              </div>
