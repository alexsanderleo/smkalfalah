...
$route['stock/out'] = 'stock/stock_in_dataout';
$route['stock/in/add'] = 'stock/stock_in_add';
$route['stock/in/addout'] = 'stock/stock_in_addout';
$route['stock/in/del/(:num)/(:num)'] = 'stock/stock_in_del';
$route['stock/in/deldua/(:num)/(:num)'] = 'stock/stock_in_deldua';



$route['pinjam/in'] = 'pinjam/pinjam_in_data';
$route['pinjam/in/add'] = 'pinjam/pinjam_in_add';
